...
export type RankedKeywordFiltersInitialValues = {
...
const RankedKeywordFilters = ({
  defaultOpen = false,
  initialValues = {},
  activeFiltersCount,
}: {
  defaultOpen?: boolean;
  initialValues?: RankedKeywordFiltersInitialValues;
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                <NumberInput
                  ...
                  size="sm"
                  minValue={1}
                  maxValue={initialValuesState.maxRankedPosition || undefined}
                  value={initialValuesState.minRankedPosition}
                  onValueChange={(val) =>
                    setInitialValuesState({
                      ...initialValuesState,
                      minRankedPosition: val,
                    })
                  }
                />
                <NumberInput
                  ...
                  label="Max."
                  size="sm"
                  minValue={initialValuesState.minRankedPosition || 0}
                  value={initialValuesState.maxRankedPosition}
                  onValueChange={(val) =>
                    setInitialValuesState({
                      ...initialValuesState,
                      maxRankedPosition: val,
                    })
                  }
                />
              </div>
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                <NumberInput
                  ...
                  size="sm"
                  minValue={0}
                  maxValue={initialValuesState.maxEstimatedTraffic || undefined}
                  value={initialValuesState.minEstimatedTraffic}
                  onValueChange={(val) =>
                    setInitialValuesState({
                      ...initialValuesState,
                      minEstimatedTraffic: val,
                    })
                  }
                />
                <NumberInput
                  ...
                  label="Max."
                  size="sm"
                  minValue={initialValuesState.minEstimatedTraffic || 0}
                  value={initialValuesState.maxEstimatedTraffic}
                  onValueChange={(val) =>
                    setInitialValuesState({
                      ...initialValuesState,
                      maxEstimatedTraffic: val,
                    })
                  }
                />
              </div>
...
export default memo(RankedKeywordFilters);
